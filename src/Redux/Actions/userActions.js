...
export const login = (email, password) => async (dispatch) => {
    try {
        ...
        const { data } = await axios.post(
            `https://murtikar.vercel.app/api/users/login`,
            { email, password },
            config
        );
...
export const register = (name, email, password) => async (dispatch) => {
    try {
        ...
        const { data } = await axios.post(
            `https://murtikar.vercel.app/api/users`,
            { name, email, password },
            config
        );
...
export const getUserDetails = (id) => async (dispatch, getState) => {
    try {
      ...
      const { data } = await axios.get(`https://murtikar.vercel.app/api/users/${id}`, config);
  ...
  export const updateUserProfile = (user) => async (dispatch, getState) => {
    try {
      ...
      const { data } = await axios.put(`https://murtikar.vercel.app/api/users/profile`,user, config);
